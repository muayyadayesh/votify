...
urlpatterns = [
    ...
    path('poll/poll_new/', poll_new.as_view(), name='poll_create'),
    ...
    path('poll/<int:pk>/poll_result', poll_result.as_view(), name='poll_result'),
    path('poll/<int:pk>/poll_vote', poll_vote, name='poll_vote'),
]
